...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors> notAllowedException(IllegalArgumentException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), "Can't use bad words! You dork! " + e.getMessage());
